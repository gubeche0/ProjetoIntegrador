                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" name="isbn" id="isbn" class="form-control" placeholder="ISBN" required value='<?php if( isset($livro) ){ ?><?php echo htmlspecialchars( $livro["isbn"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>'
                            <?php if( isset($livro) ){ ?>readonly<?php }else{ ?>autofocus<?php } ?>> </div> </div> <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" name="volume" id="volume" class="form-control" placeholder="Volume"
                                    required value='<?php if( isset($livro) ){ ?><?php echo htmlspecialchars( $livro["volume"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>'>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" name="autor" id="autor" class="form-control" placeholder="autor"
                                    required value='<?php if( isset($livro) ){ ?><?php echo htmlspecialchars( $livro["autor"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>'>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="custom-select" name="categoria" id="categoria">
                            ...
                            <option value="<?php echo htmlspecialchars( $value1['id'], ENT_COMPAT, 'UTF-8', FALSE ); ?>" <?php if( isset($livro) && $livro['categoria'] == $value1['id'] ){ ?>selected<?php } ?>><?php echo htmlspecialchars( $value1["nome"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </option> <?php } ?> </select> </div> </div> <div class="form-group row">
