...
<script>
    ...
    function excluir(id) {
        ...
        swal({
            ...
            if (result.value) {
                window.location.href = '/alunos/' + id + '/delete?page=<?php echo htmlspecialchars( $page, ENT_COMPAT, 'UTF-8', FALSE ); ?>&query=<?php echo htmlspecialchars( $query, ENT_COMPAT, 'UTF-8', FALSE ); ?>';
            }
