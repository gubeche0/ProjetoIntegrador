            ...
            <div class="panel-body">
                <form action="listarcriancas.php" method="post">
                    ...
                    <div class="form-group row">
                        <label for="nome" class="col-sm-2 col-form-label">Criança:</label>
                        <div class="col-sm-10">
                            <input id="nome" type="text" readonly class="form-control" value="<?= $registro["nome"] ?>">
                        </div>
                    </div>
                ...
                <a href="listvacina.php">Voltar</a>
