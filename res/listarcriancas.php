...
<body>
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1 class="panel-title text-center my-3">Gestão de Crianças</h1>
            </div>
            <div class="panel-body">
                <form action="listarcriancas.php" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead class="thead-light">
                        ...
                        <tr>
                            ...
                            <td>Masculino</td>
                            <td>12</td>
                            <td><a class="text-dark" href="cadcrianca.php?id=24"><i class="fas fa-edit" aria-hidden="true"></i> Editar</a></td>
                            <td><a class="text-dark" href="#" onclick="excluir(23)"><i class="fas fa-trash" aria-hidden="true"></i> Excluir</a></td>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <script>
        function excluir(id){
            ...
            if(resposta == true){
                window.location.href = "listarcriancas.php?id=" + id;
            }
        }
    </script>
