...
<body class="">
    ...
    <form class="form-signin col-sm-3 mx-auto " style="margin-top: 8%;" method="post">
        <div class="text-center">
            ...
            <input type="password" id="pass" name="pass" class="form-control" placeholder="Nova Senha" required>
            
        </div>
        
        
        <button class="btn btn-lg btn-primary btn-block mt-3" type="submit">Redefinir Senha</button>
